%%script_AP08_Get_Result_Tables Generate output tables of Aria and Paris 2008 model.
% Data is included in the table 'DATA_INPUT'.
% Output tables are:
% DATA_FIT_AP08
% DATA_FIT_I_AP08
%
% DATA_FIT_AP08 Include results for each soil data sample (so the
% number of recors match with the number of records of DATA_INPUT.
% DATA_FIT_I_AP08 Include results for each point in the water retention
...
[DATA_FIT_AP92, DATA_FIT_I_AP92] = soil_AP92_FIT(DATA_INPUT,1.38);
DATA_FIT_I_AP92.TEXTURE = categorical(DATA_FIT_I_AP92.TEXTURE);
%%
DATA_FIT_I_AP92 = DATA_FIT_I_AP92(DATA_FIT_I_AP92.SEI<1,:);
DATA_FIT_I_AP92 = DATA_FIT_I_AP92(DATA_FIT_I_AP92.SEIAP92<1,:);
DATA_FIT_I_AP92 = DATA_FIT_I_AP92(DATA_FIT_I_AP92.SEI>0,:);
DATA_FIT_I_AP92 = DATA_FIT_I_AP92(DATA_FIT_I_AP92.SEIAP92>0,:);

function [TABLE_OUT,TABLE_OUT_I] = soil_AP92_FIT(TABLEUNSAT,alfa)
