%%script_AP81_Get_Result_Tables Generate output tables of Aria and Paris 1981 model.
% Data is included in the table 'DATA_INPUT'.
% Output tables are:
% DATA_FIT_AP08
% DATA_FIT_I_AP08
%
% DATA_FIT_AP81 Include results for each soil data sample (so the
% number of recors match with the number of records of DATA_INPUT.
% DATA_FIT_I_AP81 Include results for each point in the water retention
...
[DATA_FIT_AP08, DATA_FIT_I_AP08] = soil_AP08_FIT(DATA_INPUT,1.38);
DATA_FIT_I_AP08.TEXTURE = categorical(DATA_FIT_I_AP08.TEXTURE);
%%
DATA_FIT_I_AP08 = DATA_FIT_I_AP08(DATA_FIT_I_AP08.SEI<1,:);
DATA_FIT_I_AP08 = DATA_FIT_I_AP08(DATA_FIT_I_AP08.SEIAP08<1,:);
DATA_FIT_I_AP08 = DATA_FIT_I_AP08(DATA_FIT_I_AP08.SEI>0,:);
DATA_FIT_I_AP08 = DATA_FIT_I_AP08(DATA_FIT_I_AP08.SEIAP08>0,:);

function [TABLE_OUT,TABLE_OUT_I] = soil_AP08_FIT(TABLEUNSAT,alfa)
