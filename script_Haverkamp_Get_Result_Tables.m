%%script_Haverkamp_Get_Result_Tables Generate output tables of Haverkamp, R. & Parlange, J.Y., 1986 model.
% Data is included in the table 'DATA_INPUT'.
% Output tables are:
% DATA_FIT_Haverkamp
% DATA_FIT_I_Haverkamp
%
% DATA_FIT_Haverkamp Include results for each soil data sample (so the
% number of recors match with the number of records of DATA_INPUT.
% DATA_FIT_I_Haverkamp Include results for each point in the water retention
...
[DATA_FIT_Haverkamp, DATA_FIT_I_Haverkamp] = soil_Haverkamp_FIT(DATA_INPUT,2);
DATA_FIT_I_Haverkamp.TEXTURE = categorical(DATA_FIT_I_Haverkamp.TEXTURE);
%%
DATA_FIT_I_Haverkamp = DATA_FIT_I_Haverkamp(DATA_FIT_I_Haverkamp.SEI<1,:);
DATA_FIT_I_Haverkamp = DATA_FIT_I_Haverkamp(DATA_FIT_I_Haverkamp.SEI_HA86<1,:);
DATA_FIT_I_Haverkamp = DATA_FIT_I_Haverkamp(DATA_FIT_I_Haverkamp.SEI>0,:);
DATA_FIT_I_Haverkamp = DATA_FIT_I_Haverkamp(DATA_FIT_I_Haverkamp.SEI_HA86>0,:);

function [TABLE_OUT,TABLE_OUT_I] = soil_Haverkamp_FIT(TABLEUNSAT,model)
